...
\node[step=green, below=of A] (B) {\shortstack[l]{B) Horizontal IDW (5 grid cells) to station location:\\-Dry CO\textsubscript{2} and components: Anthr, BG, RA, GPP\\-Dry Air density $\rho$}}; 
...
\matrix[column sep=1.5cm, row sep=0cm, below=2cm of B] (Cmatrix) {
  ...
  \node[step=orange] (C4) {\shortstack[l]{Dry Air density $\rho$\\- computed and interpolated\\to AK heights above ground}}; \\
};
...
\matrix[column sep=1cm, below=2cm of Ccluster] (Xmatrix) {
  ...
  \node[step=purple] (E) {\shortstack[l]{Compute layer fractions\\$\displaystyle f_\text{comp} = \frac{CO_\text{2,comp}}{CO_\text{2,total}}$}}; &
